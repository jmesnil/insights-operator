...
oc apply -f ~/tmp/container-scanner-pull-secret.yaml -n openshift-insights

oc apply -f ./manifests/010-clusterrole-container-scanner.yaml -n openshift-insights
